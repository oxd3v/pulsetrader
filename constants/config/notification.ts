...
> = {
  ...
  ["WALLET_COUNT_EXCEED"]: {
    title: "Wallet count exceed",
    message: "You cant create more wallet. Update tier.",
  },
  ["UNSUPPORTED_USER_INVITE"]: {
    title: "User cant invite",
    message: "Current tier not support invitation.",
  },
  ...
  ["TOKEN_REMOVED_SUCCESS"]: {
    title: "Succesfully token removed",
